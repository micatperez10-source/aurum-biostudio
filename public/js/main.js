...
const TRANSLATIONS = {
  ...
  es: {
    ...
    hero: {
      ...
      subtitle: "Ayudo a laboratorios y equipos biotech a analizar sus datos, crear visualizaciones claras y entender qué hacer después. Sin informes eternos, solo resultados que podés usar.",
      ctaButton: "Contame sobre tus datos",
      ctaNote: "Llamada inicial de 20 minutos sin costo ni compromiso."
    },
    whatIDo: {
      title: "Qué hago",
      intro: "Trabajo con equipos que ya tienen datos biológicos o experimentales y necesitan ayuda para entenderlos.",
      items: [
        {
          id: "exploratory",
    ...
    services: {
      title: "Servicios",
      intro: "Tres formas simples de trabajar juntos. No hace falta arreglar todo de una vez.",
      packages: [
        {
          id: "check",
          title: "Data Check",
          ...
          features: [
            ...
            "Llamada corta para entender objetivos",
      ...
      note: "Los precios dependen del tamaño y complejidad de tus datos. Confirmo el precio final después de una llamada corta."
    },
    howIWork: {
      title: "Cómo trabajo",
      ...
      steps: [
        ...
        {
          step: 2,
          title: "Analizo los datos y creo resultados claros",
          description: "Ejecuto el análisis acordado con código reproducible en Python/R, validando supuestos y valores atípicos."
        },
        {
          step: 3,
